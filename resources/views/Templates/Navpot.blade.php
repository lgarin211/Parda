<nav class="nav flex-column">
    ...
    <ul class="collapse list-unstyled" id="inventorySubmenu">
        <li class="nav-item">
            <a class="nav-link ml-2" href="#">Barang masuk</a>
        </li>
        <li class="nav-item">
            <a class="nav-link ml-2" href="#">Data Barang</a>
        </li>
    </ul>
    ...
    <ul class="collapse list-unstyled" id="penjualanSubmenu">
        <li class="nav-item">
            <a class="nav-link ml-2" href="#"> Kasir</a>
        </li>
        <li class="nav-item">
            <a class="nav-link ml-2" href="#"> Reture</a>
        </li>
    </ul>
    ...
    <ul class="collapse list-unstyled" id="accountSubmenu">
        ...
        <li class="nav-item">
            <a class="nav-link ml-2" href="#"> Sign out</a>
        </li>
    </ul>
</nav>
