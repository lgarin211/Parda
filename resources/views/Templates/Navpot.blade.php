<nav class="nav flex-column">
    ...
    <ul class="collapse list-unstyled" id="inventorySubmenu">
        <li class="nav-item">
            <a class="nav-link ml-2" href="{{ route('employe') }}"><i class="far fa-circle nav-icon"></i> Barang
                masuk</a>
        </li>
        <li class="nav-item">
            <a class="nav-link ml-2" href="{{ route('employe') }}"><i class="far fa-circle nav-icon"></i> Data
                Barang</a>
        </li>
    </ul>
